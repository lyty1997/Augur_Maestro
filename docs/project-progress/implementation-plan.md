...
| R8 | 盈立源码截图需求被误解为开发任务或实盘接入 | 范围膨胀、真实订单风险 | 源码截图归为券商申请材料事项；开发侧只解析官方 PDF，禁止真实提交 |
...
## 10. 盈立 OpenAPI 官方 PDF 解析

盈立申请材料要求源码截图，该事项与 RobustQuant 开发无关，不作为 M1 任务。开发侧只解析官方 PDF，为未来正式券商接入设计提供依据。
