...
- 总体架构：[overview.md](../../architecture/overview.md)。
- 总体路线：[technical-roadmap.md](../../project-progress/technical-roadmap.md)。
- 数据源路线：[data-source-roadmap.md](data-source-roadmap.md)。
- M1 工程设计：[engineering-design.md](../engineering-design.md)。
- M1 Kernel 接口类设计：[kernel-interfaces.md](../kernel/kernel-interfaces.md)。
...
- SQLAlchemy ORM 模型只用于基础设施层落库，不能作为 kernel 间传输对象；kernel 对外传递对象按 [kernel-interfaces.md](../kernel/kernel-interfaces.md) 定义。
